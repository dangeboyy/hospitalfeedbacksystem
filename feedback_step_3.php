...
//Fetch Faculty Name
$nm = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM faculty WHERE faculty_id='".$_SESSION['faculty_id']."'"));
         ...
         <div id="table"> 
             <div class="tr">
              ...
              <div class="td">
                     ...
                     <option value="NA" disabled selected> - - Select Doctor - -</option>
                     <?php
         			$x=mysqli_query($conn,"select distinct s1,s2 from faculty WHERE faculty_id='".$_SESSION['faculty_id']."'");
