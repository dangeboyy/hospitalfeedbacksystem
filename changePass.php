...
if(!empty($_POST))
{
	...
	if($old==$p1)
	{
		$u=mysqli_query($conn,"update admin set password='$p2' where aid='$aid'");
	}
	if($u==true)
	{
		?>
        <script type="application/javascript">
     	...
     	<?php
     	write_log("Successfully changed password");
    }else 	{ ?> 
        <script type="application/javascript">
			alert('Incorrect old password');
		</script>
		<?php
			write_log("Incorrect old password while changing password"); 
			}
}?>

<!doctype html>
<html><!-- Author İ.Mert İnan 250201038-->
	<head>
		<meta charset="utf-8">
