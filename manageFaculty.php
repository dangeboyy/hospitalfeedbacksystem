...
if(!empty($_POST))
{
	...
	$subb=$_POST['subb'];
	$faculty_id = uniqid();
	$u=mysqli_query($conn,"insert into faculty(faculty_id,name,s1,s2) values('$faculty_id','$fc','$sub','$subb')");
	if($u==true)
	{
		?>
    ...
    <body>
        ...
        <form method="post" action="" >
            <div id="table">
                ...
                <div class="tr">
            		<div class="td">
                    	<label>DOCTOR NAME I : </label>
                    </div>
                    <div class="td">
            			<input type="text" name="sub" size="25" required placeholder="Enter Doctor Full Name" />
                    </div>
                </div>
                
                <div class="tr">
            		<div class="td">
                    	<label>DOCTOR NAME II : </label>
                    </div>
                    <div class="td">
            			<input type="text" name="subb" size="25" required placeholder="Enter Doctor Full Name" />
                    </div>
                </div>
            </div>
            ...
            <br>
                ...
                <?php
            	$sr=1;
            	$h=mysqli_query($conn,"select * from faculty");
